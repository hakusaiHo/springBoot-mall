...
import com.staceyho.springbootmall.rowmapper.productRowMapper;
...
public class ProductDaoImpl implements ProductDao {
    ...
    @Override
    public Integer countProduct(PorductQueryParams productQueryParams) {
...
//      getCategory.()後面要加一個 .name()或是toString，才可以將 ENUM 類型改成字串類型，然後 insert 到資料庫裡面
